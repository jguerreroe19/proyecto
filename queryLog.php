...
<section class="queryLog-form debajodelNav">
    <div class="container">
        <form name="qLog" id = "formConsLog" action="#" method="post" class="row g-3">
            <div class="col-12">
                ...
                <div class="collapse" id="collapseExample">
                    <div class="card card-body">
                        Buscar por correo electrónico (usuario) o host. Dejar el campo en blanco para traer todos los resultados
                    </div>
                </div>
            </div>
            </br></br>
            <div class="col-md-6"> 
				...
				<input type="text" name="buscar" id="buscar" class="form-control" placeholder="Dato a buscar">
			</div>
            <div class="col-12">
