...
?>
    <section class="pwdReset-form debajodelNav">
        </br>
        <div class="container">
            <form name ="pwdRstF" id="pwdRstForm" action="#" method="post" class="row g-3">
                <div class="col-12">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="card card-body">
                            Ingrese el nombre de usuario a buscar o deje el campo en blanco para traer todos los resultados.
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
