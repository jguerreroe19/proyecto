...
?>
	<script type='text/javascript' src='js/depuraAccesos.js'></script>
<?php
...
<section class="depMov-form debajodelNav">
    <div class="container">
        <form name="dMov" id = "formdepuraMov" action="#" method="post" class="row g-3">
            </br></br>
            <div class="col-12">
