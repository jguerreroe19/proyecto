$(document).ready(function(){
    ...
    $.fn.changeHeaderTitle('Depurar bitácora de Accesos');
        ...
        .done(function(res){
            ...
            const data = {
                ...
                const myChart = new Chart(
                    document.getElementById('graficaAccesos'),
                    config
                );
    ...
    $('#btnDepurar').click(function(){ //Al presionar el botón Buscar
        ...
        //Obtiene los valores de los campos
            ...
            $.ajax({
                url: 'includes/depuraAccesos.inc.php',
                type: 'POST',
                    ...
                    $.confirm({
                        ...
                        buttons: {
                                Aceptar: function () {
                                    ...
                                    $.ajax({
                                        url: 'includes/deleteAccesos.inc.php',
                                        type: 'POST',
                                        data: {idsesion: vidsesion, idrol: vidrol, fechaInicio: fini, fechaFin: ffin},
                                    })
                                    .done(function(res){
                                        if (res == 'error'){
                                            $.confirm({
                                                ...
                                                content: 'Error al depurar la tabla de Accesos. Intentelo nuevamente o revise el log de errores para más detalles',
                                                type: 'red',
                                                typeAnimated: true,
                                                buttons: {
                                                        Aceptar: function () {
                                            ...
                                            $.confirm({
                                                title: '<i class="bi bi-x-circle" style= "color: red;"></i> Error',
                                                content: 'Error inesperado. Revise el log de errores para más detalles ' + res,
                                                type: 'red',
                                                typeAnimated: true,
                                                buttons: {
                                                        Aceptar: function () {
